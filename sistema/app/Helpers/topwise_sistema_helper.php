<?php
	...
	function TopWise_App_Nome() {
		return 'TopWise Artefato';
	}

	function TopWise_App_Versao() {
		return '22.6 r1 build 1';
	}

	function TopWise_App_Data_Release() {
		return '10/05/2022 11:57'; // iniciado em 18/02/2022
	}
	...
	function TopWise_App_Sistema_Descricao() {
		return 'Sistema Base para Desenvolvimento em CI 4 e AdminLTE 3';
	}
